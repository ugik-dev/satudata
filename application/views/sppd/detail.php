                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php
                                ?>
                                <!-- <a class="btn btn-primary" href="<?= base_url('sppd/edit/' . $dataContent['return_data']['id_spd']) ?>"><strong>Edit </strong></a> -->
                                <!-- </div> -->
                            </div>
                            <div class="col-lg-6">
                                <div class="row">
    ...
    $(document).ready(function() {
        ...
        $('#approv_btn').on('click', (ev) => {
            ...
            swal({
                ...
                $.ajax({
                    url: '<?= base_url('sppd/action/approv/' . $dataContent['return_data']['id_spd']) ?>',
                    'type': 'get',
                    data: {
        ...
        $('#deapprov_btn').on('click', (ev) => {
            ...
            swal({
                ...
                $.ajax({
                    url: '<?= base_url('sppd/action/unapprov/' . $dataContent['return_data']['id_spd']) ?>',
                    'type': 'get',
                    data: {
        ...
        $('#batal_aksi').on('click', (ev) => {
            ...
            swal({
                ...
                $.ajax({
                    url: '<?= base_url('sppd/action/undo/' . $dataContent['return_data']['id_spd']) ?>',
                    'type': 'get',
                    data: {
