        ...
        <form id="user_form" onsubmit="return false;" type="multipart" autocomplete="off">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <input type="" name="id_spd" value="<?= !empty($dataContent['return_data']['id_spd']) ? $dataContent['return_data']['id_spd'] : '' ?>">
    ...
    $(document).ready(function() {
            ...
            $('.delete_dasar_tambahan').on('click', function(event) {
                ...
                swal({
                    ...
                    if (!newrow) {
                        ...
                        $.ajax({
                            url: '<?= base_url('sppd/delete_dasar') ?>',
                            'type': 'get',
                            data: {
        ...
        $('.delete_dasar_tambahan_lama').on('click', function(event) {
            ...
            swal({
                ...
                var currentData = $(this).data('id');
                $.ajax({
                    url: '<?= base_url('sppd/delete_dasar_tambahan') ?>',
                    'type': 'get',
                    data: {
                        'id_dasar_tambahan': currentData
                    },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        swal({
                            ...
                            location.href = "<?= base_url('sppd/detail/') ?>" + json['data'];
                        });
                    }
                });
            });
