...
<div class="modal fade" id="riwaat_modal" style="overflow:hidden;">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var UserModal = {
            'self': $('#riwaat_modal'),
            'info': $('#riwaat_modal').find('.info'),
            'form': $('#riwaat_modal').find('#user_form'),
            'addBtn': $('#riwaat_modal').find('#add_btn'),
            'saveEditBtn': $('#riwaat_modal').find('#save_edit_btn'),
            'id_riwayat': $('#riwaat_modal').find('#id_riwayat'),
            'jabatan': $('#riwaat_modal').find('#jabatan'),
            'id_satuan': $('#riwaat_modal').find('#id_satuan'),
            'id_role': $('#riwaat_modal').find('#id_role'),
            'tanggal_aktif': $('#riwaat_modal').find('#tanggal_aktif'),
            'status_riwayat': $('#riwaat_modal').find('#status_riwayat'),
        }
