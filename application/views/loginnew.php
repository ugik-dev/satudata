...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<?= base_url() ?>assets/metronic/media/bg/bg-12.jpg);">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        <div class="mb-10">
                            <h2 class="opacity-90 font-weight-normal" style="color: #326632"><strong>PT Agro Marina Anugerah Lestari</strong> </h2>
                            <!-- <p class="opacity-40">Enter your details to login to your account:</p> -->
                        </div>
                        <form action="<?= base_url() ?>login/authentication" method="post" class="form" id="kt_login_signin_form">

                            <div class="form-group">
                                <input class="form-control h-auto text-black bg-white rounded-pill border-8 py-4 px-8" type="text" placeholder="Email" name="username" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <input class="form-control h-auto text-black bg-white rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" name="password" />
                            </div>
                            <div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8 opacity-100">
                            ...
                            <div class="form-group text-center mt-10">
                                <button id="kt_login_signin_submit" style="background-color: #326632;" class="btn btn-pill btn-success px-15 py-3"><strong>Masuk</strong></button>
                            </div>
                        </form>
                    ...
                    <div class="login-forgot">
                        ...
                        <form class="form" action="<?= base_url() ?>Forget_password/forget_password_administrator" method="post" id="kt_login_forgot_form">
                            <div class="form-group mb-10">
                                <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="Email" name="username_forgot" autocomplete="off" />
                            </div>
                            <div class="form-group">
