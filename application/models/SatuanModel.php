    ...
    public function action_satuan($data)
    {
        ...
        if (!empty($data['id_satuan'])) {
            ...
            $this->db->update('satuan', DataStructure::slice($data, [
                'jen_satker', 'nama_satuan', 'nama_satuan2', 'nama_dinas', 'alamat', 'alamat_lengkap', 'kode_pos', 'email', 'no_tlp', 'website', 'kode_surat', 'ktrngn', 'satuan_tempat', 'bendahara', 'bendahara_pem', 'verif_cuti'
            ], FALSE));
